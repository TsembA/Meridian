{{/*
_helpers.tpl — Template helper functions for the meridian-app Helm chart.
These are reusable named templates included via `include` in other templates.
*/}}

{{/* Expand the name of the chart */}}
{{- define "meridian-app.name" -}}
...
*/}}
{{- define "meridian-app.labels" -}}
helm.sh/chart: {{ include "meridian-app.chart" . }}
{{ include "meridian-app.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "meridian-app.selectorLabels" -}}
app.kubernetes.io/name: {{ include "meridian-app.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{/* Service account name resolution */}}
{{- define "meridian-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "meridian-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
